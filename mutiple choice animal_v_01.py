...
class YoungAnimalQuiz:
    def __init__(self, root):
        ...
        self.root.configure(bg="#F0F4C3")  # Set a soft background color

        # Set up the default font for all widgets
        self.default_font = tkfont.nametofont("TkDefaultFont")
        self.default_font.configure(size=12, family="Helvetica")  # Use a modern font
    ...
    def load_questions_from_csv(self, csv_file):
        ...
        with open(csv_file, 'r') as file:
            ...
            for row in animals_young_only:
                ...
                options = [row[1]] + row[2:]
                correct_index = 0  # The correct answer is always the first in the options list
                questions.append({"question": question, "options": options, "correct_index": correct_index})
        return questions
    ...
    def check_answer(self, selected_option):
        ...
        if self.round_count < self.num_rounds:
            ...
            feedback_label = tk.Label(self.root, text=feedback, font=self.default_font, bg="#F0F4C3")
            feedback_label.pack(pady=20)

            next_round_button = tk.Button(self.root, text="Next Round", command=self.display_question,
                                          font=self.default_font, bg="#AED581", activebackground="#8BC34A",
    ...
    def display_help(self):
        ...
        help_text = ("This is a quiz about young animals. You will be asked a series of questions "
                     ...
                     "will proceed to the next question. Good luck!")
