...
class YoungAnimalQuiz:
    ...
    class YoungAnimalQuiz:
        ...
        def choose_rounds(self):
            ...
            welcome_label = tk.Label(main_frame, text="Welcome to the Young Animal Quiz!",
        ...
        def display_question(self):
            ...
            if self.round_count < self.num_rounds:
                ...
                question_label = tk.Label(main_frame, text=question_data["question"], font=self.default_font,
                                          bg="#F0F4C3")
                ...
                for i, option in enumerate(question_data["options"]):
                    option_button = tk.Button(option_frame, text=option,
        ...
        def display_final_score(self):
            ...
            play_again_button = tk.Button(main_frame, text="Play Again", command=self.play_again,
                                          font=self.default_font,
    ...
    def clear_window(self):
        # Clears all widgets except error label
        for widget in self.root.winfo_children():
